...
function __construct(){
	...
	$widget_ops = array(
		...
		'description' => __('A widget that displays your Flickr photos.', 'tophica')
	);
	...
	// Create the widget
	//$this->WP_Widget( 'tz_flickr_widget', __('Custom Flickr Photos', 'tophica'), $widget_ops, $control_ops );
	parent::__construct( 
		'tz_flickr_widget', 
		__('Custom Flickr Photos', 'tophica'), 
		$widget_ops, 
		$control_ops 
	);
...
function form( $instance ) {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'flickrID' ); ?>"><?php _e('Flickr ID:', 'tophica') ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php _e('Number of Photos:', 'tophica') ?></label>
	...
	<!-- Type: Select Box -->
	<p>
		<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e('Type (user or group):', 'tophica') ?></label>
	...
	<!-- Display: Select Box -->
	<p>
		<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php _e('Display (random or latest):', 'tophica') ?></label>
