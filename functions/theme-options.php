...
// CUSTOM ALT TAGS
$options[] = array( "name" => __('Slider Image 1 Alt Tag','framework'),
					"desc" => __('Enter an alt description for this image.','framework'),
...
// CUSTOM ALT TAGS
$options[] = array( "name" => __('Slider Image 2 Alt Tag','framework'),
					"desc" => __('Enter an alt description for this image.','framework'),
...
// CUSTOM ALT TAGS
$options[] = array( "name" => __('Slider Image 3 Alt Tag','framework'),
					"desc" => __('Enter an alt description for this image.','framework'),
...
// CUSTOM ALT TAGS
$options[] = array( "name" => __('Slider Image 4 Alt Tag','framework'),
					"desc" => __('Enter an alt description for this image.','framework'),
...
// CUSTOM ALT TAGS
$options[] = array( "name" => __('Slider Image 5 Alt Tag','framework'),
					"desc" => __('Enter an alt description for this image.','framework'),
